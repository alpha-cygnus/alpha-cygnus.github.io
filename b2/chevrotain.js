...
var extendStatics = Object.setPrototypeOf ||
        ...
        function (d, b) { for (var p in b) /* istanbul ignore next */  if (b.hasOwnProperty(p)) d[p] = b[p]; };
    return function (d, b) {
        extendStatics(d, b);
...
var lexer_public_1 = __webpack_require__(6);
...
function extendToken(tokenName, patternOrParent, parentConstructor) {
    ...
    if (utils_1.isRegExp(patternOrParent) ||
        ...
        utils_1.isString(patternOrParent)) {
...
var END_OF_FILE = tokens_public_1.createTokenInstance(tokens_public_1.EOF, "", NaN, NaN, NaN, NaN, NaN, NaN);
...
var Parser = (function () {
    function Parser(input, tokensDictionary, config) {
        ...
        if (!this.outputCst) {
            ...
            this.invokeRuleNoTry = this.invokeRuleNoTryNoCst;
        }
    ...
    Parser.prototype.invokeRuleNoTryNoCst = function (args, impl) {
        var result = impl.apply(this, args);
        this.ruleFinallyStateUpdate();
        return result;
    };
    Parser.prototype.invokeRuleNoTry = function (args, impl) {
        impl.apply(this, args);
        var result = this.CST_STACK[this.CST_STACK.length - 1];
        this.ruleFinallyStateUpdate();
        return result;
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var tokens_public_1 = __webpack_require__(2);
var lexer_1 = __webpack_require__(22);
var utils_1 = __webpack_require__(0);
var tokens_1 = __webpack_require__(7);
...
var utils_1 = __webpack_require__(0);
var tokens_public_1 = __webpack_require__(2);
var first_1 = __webpack_require__(9);
...
var utils = __webpack_require__(0);
var utils_1 = __webpack_require__(0);
var parser_public_1 = __webpack_require__(4);
var gast_public_1 = __webpack_require__(1);
var gast_1 = __webpack_require__(8);
var tokens_public_1 = __webpack_require__(2);
var first_1 = __webpack_require__(9);
var lookahead_1 = __webpack_require__(14);
var version_1 = __webpack_require__(15);
var cst_1 = __webpack_require__(16);
...
var OccurrenceValidationCollector = (function (_super) {
    ...
    function OccurrenceValidationCollector() {
        var _this = _super !== null && _super.apply(this, arguments) /* istanbul ignore next */ || this;
...
function buildSingleAlternativeLookaheadFunction(alt, tokenMatcher, tokenClassIdentityFunc, tokenInstanceIdentityFunc, dynamicTokensEnabled) {
    ...
    if (areAllOneTokenLookahead && !dynamicTokensEnabled) {
        ...
        if (singleTokensClasses.length === 1 &&
            ...
            return function () {
                return (tokenInstanceIdentityFunc(this.LA(1)) ===
            ...
            return function () {
                var nextToken = this.LA(1);
                return choiceToAlt_2[tokenInstanceIdentityFunc(nextToken)] ===
                    true
                    ? true
                    : false;
            };
    ...
    NamedDSLMethodsCollectorVisitor.prototype.visitAlternation = function (node) {
        ...
        utils_1.forEach(node.definition, function (currFlatAlt, altIdx) {
            if (!utils_1.isUndefined(currFlatAlt.name)) {
                ...
                _this.result.push({ def: def, key: key, name: currFlatAlt.name });
            }
        });
    };
